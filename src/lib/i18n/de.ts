const de = {
  ...
  "public.accountDescription": "Dieses Konto wird über die eingegebene Benutzer-ID geladen.",
  ...
  "public.userResolveFailedTitle": "Benutzer-ID eingeben",
  "public.userResolveFailedDesc": "Bitte geben Sie Ihre Benutzer-ID ein, um Ihr Druckkonto zu laden.",
