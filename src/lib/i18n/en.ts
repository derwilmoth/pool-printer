...
const en: Record<TranslationKey, string> = {
  ...
  "public.accountDescription": "This account is loaded using the entered user ID.",
  "public.transactionsTitle": "Transaction History",
  "public.transactionsDescription": "All past bookings with printable receipt.",
  "public.userResolveFailedTitle": "Enter user ID",
  "public.userResolveFailedDesc": "Please enter your user ID to load your print account.",
